...
//  Day 3 No Storyboard
//
//  Created by Keith McClung on 5/12/14.
...
{
    [super viewDidLoad];
    self.studentsArray = @[@"Chad",@"Keith",@"Tallis",@"Bob",@"Dana",@"Greg",@"Aidan",@"Charles",@"Dan",@"Will",@"Excessive People"];
...
{
    NSLog(@"This is the person in this row: %@",self.studentsArray[indexPath.row]);
}
